...
export default function Hero({ onScrollToSection, onOpenJoinModal }: HeroProps) {
  return (
    <section id="hero" className="relative overflow-hidden bg-gradient-to-b from-[#FAF8F3] via-[#FAF8F3] to-[#FAF8F3]/50 py-12 md:py-20 lg:py-28">
      ...
      <div className="absolute right-10 bottom-10 -z-10 h-80 w-80 rounded-full bg-[#7BBF6A]/10 blur-3xl"></div>
      <div className="absolute left-10 top-1/3 -z-10 h-64 w-64 rounded-full bg-[#F4B36A]/15 blur-3xl"></div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            {/* Tagline */}
            <div className="inline-flex items-center space-x-2 rounded-full bg-[#7BBF6A]/10 px-4 py-2 text-[#7BBF6A]">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight tracking-tight">
              退休，不是人生的終點，
              <br />
              <span className="bg-gradient-to-r from-[#7BBF6A] to-[#F4B36A] bg-clip-text text-transparent">
                而是精彩人生的新起點。
              </span>
            </h1>
            ...
            <div className="grid grid-cols-3 gap-3 pt-2">
              <div className="flex flex-col items-center lg:items-start p-3 bg-white rounded-xl border border-[#EBE6DD] shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
              <button
                ...
                className="flex w-full sm:w-auto items-center justify-center space-x-2 rounded-2xl bg-[#7BBF6A] hover:bg-[#6AA85B] text-white px-8 py-5 text-xl font-bold shadow-lg shadow-green-200 transition-all transform hover:-translate-y-1"
              >
              ...
              <button
                ...
                className="flex w-full sm:w-auto items-center justify-center space-x-2 rounded-2xl bg-[#F4B36A] hover:bg-[#E29F55] text-white px-8 py-5 text-xl font-bold shadow-lg shadow-orange-200 transition-all transform hover:-translate-y-1"
              >
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-[450px] lg:max-w-none">
              ...
              <div className="absolute -inset-1.5 rounded-3xl bg-gradient-to-r from-[#7BBF6A] to-[#F4B36A] opacity-30 blur-md"></div>
              
              {/* Picture Frame / Circular Sticker Design */}
              <div className="relative overflow-hidden rounded-full border-8 border-[#2E4D2A] bg-white shadow-2xl aspect-square w-full max-w-[420px] mx-auto p-6 flex flex-col justify-between items-center text-center">
                
                {/* Sticker inner thin circle */}
                <div className="absolute inset-2 rounded-full border-2 border-[#EBE6DD] pointer-events-none"></div>
                ...
                <div className="relative mt-14 flex flex-col items-center">
                  ...
                  <div className="relative h-32 w-32 flex items-center justify-center">
                    ...
                    <span 
                      className="absolute text-5xl animate-bounce flex items-center justify-center cursor-default select-none" 
                      style={{ 
                        left: "-64px", 
                        top: "36px", 
                    ...
                    <div 
                      className="absolute bg-white border border-[#EBE6DD] w-14 h-14 rounded-2xl shadow-md text-3xl animate-bounce flex items-center justify-center cursor-pointer hover:scale-110 transition-transform duration-200" 
                      style={{ 
                        left: "-36px", 
                        top: "-25px", 
                    ...
                    <span 
                      className="absolute text-5xl text-rose-500 animate-bounce flex items-center justify-center cursor-default select-none" 
                      style={{ 
                        left: "76px", 
                        top: "-56px", 
                ...
                <div className="relative z-10 my-1 space-y-1.5 px-4">
                  ...
                  <h3 className="text-xl sm:text-2xl font-black text-[#8E5136] leading-tight">
                    而是「<span className="text-[#7BBF6A]">玩美人生</span>」的起跑點！
                  </h3>
                ...
                <div className="relative z-10 w-full mb-2">
                  <div className="inline-flex items-center space-x-2 bg-[#2E4D2A] text-white px-6 py-2 rounded-full font-black text-sm tracking-wide shadow-md border-2 border-white/20">
